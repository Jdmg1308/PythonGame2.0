...
os.chdir(r'd:\My_Stuff\Personal_projects\second_game\PythonGame2.0')
...
os.chdir("..")
os.chdir("HIM")
Dark_walkRight = [pygame.image.load(r"caminar derecha Him-1.png.png"), pygame.image.load(r"caminar derecha Him-2.png.png")]
...
os.chdir("..")
os.chdir("Final attack")
FINAL_ATTACK = [
pygame.image.load(r"FINALATTACK_01.png"), 
pygame.image.load(r"FINALATTACK_02.png"),
pygame.image.load(r"FINALATTACK_03.png"),
pygame.image.load(r"FINALATTACK_04.png"),
pygame.image.load(r"FINALATTACK_05.png"),
pygame.image.load(r"FINALATTACK_06.png"),
pygame.image.load(r"FINALATTACK_07.png"),
pygame.image.load(r"FINALATTACK_08.png"),
pygame.image.load(r"FINALATTACK_09.png"),
pygame.image.load(r"FINALATTACK_10.png"),
pygame.image.load(r"FINALATTACK_11.png"),
pygame.image.load(r"FINALATTACK_12.png"),
pygame.image.load(r"FINALATTACK_13.png"),
pygame.image.load(r"FINALATTACK_14.png"),
pygame.image.load(r"FINALATTACK_15.png"),
pygame.image.load(r"FINALATTACK_16.png"),
pygame.image.load(r"FINALATTACK_17.png"),
pygame.image.load(r"FINALATTACK_18.png"),
pygame.image.load(r"FINALATTACK_19.png"),
pygame.image.load(r"FINALATTACK_20.png"),
pygame.image.load(r"FINALATTACK_21.png")
]
...
os.chdir("HIM")
FINAL_HIM = [
pygame.image.load(r"HIM_00.png"), 
pygame.image.load(r"HIM_01.png"),
pygame.image.load(r"HIM_02.png"), 
pygame.image.load(r"HIM_03.png"),
pygame.image.load(r"HIM_04.png"), 
pygame.image.load(r"HIM_05.png"),
pygame.image.load(r"HIM_06.png"), 
pygame.image.load(r"HIM_07.png"),
pygame.image.load(r"HIM_08.png"), 
pygame.image.load(r"HIM_09.png"),
pygame.image.load(r"HIM_10.png"), 
pygame.image.load(r"HIM_11.png"),
pygame.image.load(r"HIM_12.png")
]
os.chdir("..")
for i in range(13):
